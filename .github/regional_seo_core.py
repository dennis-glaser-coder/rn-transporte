...
REGIONS = [
    ...
    },
    {
        ...
        "name": "Gütersloh, Lippstadt & Soest",
        "short": "Gütersloh / Lippstadt / Soest",
        "title": "Betonlogistik Gütersloh, Lippstadt & Soest | RN Transporte",
        "description": "Betonpumpendienst, Frischbeton- und Kiestransporte im Raum Gütersloh, Lippstadt und Soest. RN Transporte koordiniert Einsätze aus Salzkotten.",
        "hero": "Betonlogistik zwischen Gütersloh, Lippstadt und Soest.",
        "intro": "Regional gut erreichbar für Baustellen entlang der Achse Gütersloh–Lippstadt–Soest.",
        "heading": "Kurze Wege für Baustellen westlich von Salzkotten.",
        "paragraphs": [
            "Geseke und Lippstadt liegen unmittelbar westlich unseres Standorts; auch Gütersloh, Erwitte und Soest gehören zu unserem regionalen Kerngebiet. Das erleichtert die direkte Abstimmung bei zeitkritischen Baustelleneinsätzen.",
        ...
        "places": ["Gütersloh", "Lippstadt", "Geseke", "Erwitte", "Soest"],
